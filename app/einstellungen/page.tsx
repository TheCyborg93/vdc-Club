...
import { setIntegrationEnabledAction } from "@/app/einstellungen/actions";
    ...
    <div className="page-stack">
      <section className="page-heading">
        <div>
          ...
          <h1>Einstellungen & Integrationen</h1>
          <p>Rollen, aktive Saison und die Verbindungen zwischen VDC‑Club, TC, Turnier und Training zentral überwachen.</p>
        </div>
      </section>
