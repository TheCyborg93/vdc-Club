...
const modules: GuideModule[] = [
  ...
  },
  {
    ...
    capabilities: [
      ...
      "Hall-of-Fame-Rekorde und Mehrfachsieger automatisch auswerten",
      "Finalergebnis, Format, Spielort, Teilnehmerzahl, Average, High Finish und Shortleg dokumentieren",
      "Hall-of-Fame-Titel mit einem passenden Fotoalbum verknüpfen",
      ...
      "Alben öffnen und Fotos in einer Vollbildansicht durchblättern",
      "Fotos herunterladen, Titelbilder bestimmen und Bilder wieder löschen",
  ...
  },
  {
    ...
    description: "Vorstandssitzungen in drei klaren Schritten abwickeln: Vorbereitung → Sitzung → Protokoll.",
    capabilities: [
      "Neue Sitzung anlegen: aktive Vorstandsmitglieder werden automatisch eingeladen; 1. Vorsitzender und Schriftführer werden aus den Rollen vorbelegt",
      "Vorbereitung: Sitzungsdaten, Einladung, Teilnehmer, Gäste und allgemeine Sitzungsanlagen zentral pflegen",
      "TOPs als Information, Beratung oder Beschluss kennzeichnen, per Drag & Drop sortieren und mit Sachverhalt vorbereiten",
      "Offene Punkte aus der vorherigen Sitzung mit einem Klick übernehmen; nachträglich ergänzte TOPs werden automatisch gekennzeichnet",
      "Sitzungsbeginn: Anwesenheit von Vorstand und Gästen bestätigen und danach die Beschlussfähigkeit feststellen",
      "Live-Sitzung im Fokusmodus ohne normale Navigation durchführen und immer nur den aktuellen TOP bearbeiten",
      "Ergebnisnotizen automatisch zwischenspeichern und Schnellbausteine wie Zur Kenntnis genommen, Erledigt, Vertagt oder Keine Entscheidung verwenden",
      "Beschluss-TOPs können nicht ohne dokumentierte Abstimmung als erledigt abgeschlossen werden",
      "Beschlüsse im kompakten Dialog mit Wortlaut, Abstimmungsart, Stimmberechtigten, Ausschlüssen, Ja/Nein/Enthaltung und Ergebnis erfassen",
      "Folgeaufgaben mit Verantwortlichen und Fristen direkt aus angenommenen Beschlüssen erzeugen",
      "TOP-Anlagen und allgemeine Sitzungsanlagen getrennt verwalten und gemeinsam im Protokoll ausgeben",
      "Sitzungsende über eine Abschlussprüfung durchführen; Endzeit, Abschlussbemerkung und optional den nächsten Sitzungstermin erfassen",
      "Optional aus dem nächsten Termin direkt die nächste Vorstandssitzung mit Vorstand, Vorsitz und Schriftführer anlegen",
      "Protokoll nach Sitzungsende automatisch aus Formalia, Teilnahme, TOP-Ergebnissen, Beschlüssen und Anlagen erzeugen",
      "Vor der Einreichung sämtliche Sitzungsdaten nachbearbeiten: Formalia, Zeiten, Rollen, Teilnehmer, Gäste, TOPs, Abstimmungen, Ausschlüsse, Beschlüsse und Anlagen",
      "Jede nachträgliche Korrektur benötigt einen Grund und wird mit Benutzer und Zeitpunkt im Änderungsverlauf gespeichert",
      "Vor der Prüfung validiert die App erneut Formalia, Anwesenheit, TOP-Status, Beschlüsse, Abstimmungssummen und Ausschlüsse",
      "Workflow Entwurf → Prüfung → Freigabe & automatische Archivierung nutzen",
      "Vorsitz bzw. Vertretung kann freigeben oder mit Rückgabegrund zur Überarbeitung zurückgeben",
      "Versionen, Rückgaben, Freigaben und Änderungsverlauf dauerhaft nachvollziehen",
    ],
  },
  {
    title: "Umfragen",
  ...
  },
  {
    ...
    description: "Finanzbewegungen, Budgets und Mitgliedsbeiträge mit individuellen Beitragsmodellen zentral verwalten.",
    capabilities: [
      "Einnahmen, Ausgaben und Budgets verwalten",
      "Beitragsarten wie Standard, Jugend oder Ermäßigt anlegen",
      "Mitgliedern individuelle Beitragssätze und Zahlungsrhythmen zuordnen",
