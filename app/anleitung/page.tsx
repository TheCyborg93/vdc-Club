...
const modules: GuideModule[] = [
  ...
  },
  {
    ...
    description: "Vorstandssitzungen vorbereiten, durchführen und mit einem vollständigen Schriftführer-Workflow abschließen.",
    capabilities: [
      "Einladung, Einladungsweg, Frist und mitgesendete Tagesordnung dokumentieren",
      "Sitzungsart, Beschlussfähigkeit und zugrunde liegende Satzungs-/Geschäftsordnungsregel festhalten",
      "Tagesordnung vorbereiten, Gäste verwalten und offene Punkte aus der vorherigen Sitzung übernehmen",
      "Sitzungsleitung und Protokollführung festlegen",
      "Stimmberechtigung je Teilnehmer und Befangenheit je TOP dokumentieren",
      "TOPs als angekündigt oder nachträglich ergänzt kennzeichnen und Sonderfälle begründen",
      "TOP-Notizen während der Sitzung automatisch zwischenspeichern",
      "Anträge mit exaktem Wortlaut, Abstimmungsart, Stimmberechtigten, Ja/Nein/Enthaltung und Ergebnis erfassen",
      "Folgeaufgaben mit Verantwortlichen und Fristen direkt aus angenommenen Beschlüssen erzeugen",
      "Unterlagen als Anlagen direkt mit einem TOP verknüpfen",
      "Vor Sitzungsende eine formale Abschlussprüfung durchführen",
      "Protokolle mit Einleitung, Abschlussbemerkung und nächstem Sitzungstermin vervollständigen",
      ...
      "Versionen und Freigabeverlauf nachvollziehen",
      "Freigegebene Protokolle automatisch im Dokumentenbereich und Archiv führen",
    ],
  },
  {
    title: "Umfragen",
