      ...
      <section className="meeting-v3-readiness">
        ...
        {canWrite && state==="ready" && (
          <div className="meeting-v3-readiness-actions">
            <Link href={`/sitzungen/${id}/start`} className="primary-button">Startcheck öffnen</Link>
        ...
        {state==="live" && (
          <div className="meeting-v3-readiness-actions">
            <Link href={`/sitzungen/${id}/live`} className="primary-button">Live-Sitzung öffnen</Link>
          </div>
        )}
      </section>
